'''
Generate SVG schema of DB from sqlalchemy models
need here (plain) for "tricky" lib-import, due lib is unrecognized after installation

* also in this file u can redo the way tables-schema is displayed:
 colors, 
 widths, 
 etc

src: https://github.com/Dicklesworthstone/sqlalchemy_data_model_visualizer
'''
